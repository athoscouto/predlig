...
sample.set_classification_dataset("amazon_classification_attributes", "amazon_classification")
table = sample.get_classification_dataset()
number_of_attributes = len(sample.ordered_attributes_list)
message = "Dataset Amazon\n"
classifiers = {"MLP": {"activation": "logistic", "hidden_layer_sizes": (20, 24, 16), "learning_rate_init": 0.7}}
