...
class CDConstructor(object):
    ...
    def set_graphs(self):
        ...
        if (self.task == "missing_link_prediction") and (self.sample_dataset is not None):
            # TODO Athos Couto - [07-12-2015]: Check if name substituition of the name "line" for "_line" was correct
            for line in [_line for _line in self.sample_dataset if _line[2] == 1]:
