...
sample.set_classification_dataset('microsoft_classification_attributes', 'microsoft_classification')
table = sample.get_classification_dataset()
number_of_attributes = len(sample.ordered_attributes_list)
message = "Dataset Microsoft\n"
classifiers = {"MLP": {"activation": "logistic", "hidden_layer_sizes": (8, 10), "learning_rate_init": 0.7}}
metrics = ["precision", "f1", "roc_auc"]

print "We have to run {} metrics.".format(len(metrics))
