...
sample = CDConstructor("../examples/datasets/microsoft_training.txt", 10000, (0.5, 0.5), "future_link_prediction", "microsoft_test.txt")
sample.set_classification_dataset('../examples/datasets/microsoft_final_version_attributes', '../examples/datasets/microsoft_final_version')
table = sample.get_classification_dataset()
number_of_attributes = len(sample.ordered_attributes_list)
message = "Dataset Microsoft\n"
